...
<? if (!empty($arResult["ORDER"])): ?>
    ...
    <hr>
     <?$APPLICATION->IncludeComponent(
         ...
         Array(
             "AREA_FILE_SHOW" => "file",
             "PATH" => "/local/include/payment_description.php",
						...
						if (empty($arPaySystem["ERROR"]))
						{
                            ...
                            <div class="row">
                                <div class="col-sm-3 col-lg-3">
                                    <p><div class="pay_name"><?=Loc::getMessage("SOA_PAY") ?></div>
...
<? endif ?>
    ...
    <br><br>
<img src="<?=SITE_TEMPLATE_PATH?>/images/allinone.png" alt="Платежные системы">
