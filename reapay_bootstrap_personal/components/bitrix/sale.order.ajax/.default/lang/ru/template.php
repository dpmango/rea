...
$MESS["BUYER_BLOCK_NAME_DEFAULT"] = "Обучающийся";
...
$MESS["ORDER_DESC_DEFAULT"] = "Комментарии:";
$MESS["SELECT_FILE_DEFAULT"] = "Выбрать";
$MESS["SUCCESS_PRELOAD_TEXT_DEFAULT"] = "Часть данных была заполнена автоматически с учетом информации из вашего профиля.<br /> 
